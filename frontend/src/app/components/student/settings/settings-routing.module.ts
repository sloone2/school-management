...
import { StudentBillingAddressComponent } from './student-billing-address/student-billing-address.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'student-billing-address',
        component: StudentBillingAddressComponent,
      },
    ],
  },
];
